  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl h-[620px] bg-white rounded-3xl shadow-2xl border border-white/20 overflow-hidden flex flex-col md:flex-row">
        ...
        <div
          className={`w-full md:w-1/2 h-full p-8 flex flex-col justify-center bg-white transition-all duration-500 ${
            !isSignUpActive
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-400 font-medium mt-1">
              Access your account dashboard hub
            </p>
          </div>
          ...
          <form onSubmit={handleSignInSubmit} className="space-y-4">
            ...
            >
              <FaSignInAlt size={14} />{" "}
              {loading ? "Verifying Keys..." : "Sign In"}
            </button>
          </form>
        ...
        <div
          className={`w-full md:w-1/2 h-full p-8 flex flex-col justify-center bg-white absolute md:relative top-0 left-0 w-full h-full transition-all duration-500 ${
            isSignUpActive
              ? "opacity-100 pointer-events-auto z-10"
              : "opacity-0 pointer-events-none md:opacity-100 md:pointer-events-auto z-0"
          }`}
        >
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-400 font-medium mt-1">
              Register to save product customization items
            </p>
          </div>
        ...
        <div
          className={`hidden md:flex absolute top-0 left-0 w-1/2 h-full bg-[#111827] text-white flex-col items-center justify-center p-12 transition-transform duration-700 ease-in-out z-20 ${
            isSignUpActive
              ? "translate-x-0 rounded-r-[80px]"
              : "translate-x-full rounded-l-[80px]"
          }`}
          style={{
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-4">
            <div
              className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center border border-white/20 shadow-inner animate-bounce"
            ...
            {isSignUpActive ? (
              <>
                ...
                <p className="text-xs text-gray-300 font-medium max-w-xs leading-relaxed">
                  Log back into your secure profile dashboard to complete
                  pending orders or track deliveries.
                </p>
                <button
                  type="button"
                  onClick={() => handleModeChange("signin")}
              ...
              <>
                ...
                <p className="text-xs text-gray-300 font-medium max-w-xs leading-relaxed">
                  Create an account profile today to build and customize premium
                  team kits smoothly.
                </p>
                <div className="flex flex-col">
                  ...
                  <button
                    type="button"
                    onClick={() => router.push("/")}
                    className="px-9 py-2.5 rounded-xl border border-white/40 hover:border-orange-500 hover:bg-orange-500 text-white font-bold text-xs uppercase tracking-widest transition-all cursor-pointer mt-4"
                  >
                    Guest
                  </button>
                </div>
